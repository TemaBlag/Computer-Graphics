...
def test_create_line(capsys):
    with capsys.disabled():
        with patch("tkinter.Tk"), patch("tkinter.Canvas") as MockCanvas:
            ...
            results = []
            for i in range(k):
                PixelPath.create_line(mock_canvas_instance, 0, 0, 100, 100, new=False)
...
def test_dda(capsys):
    with capsys.disabled():
        with patch("tkinter.Tk"), patch("tkinter.Canvas") as MockCanvas:
            ...
            results = []
            for i in range(k):
                PixelPath.dda(mock_canvas_instance, 0, 0, 100, 100, new=False)
                results.append(PixelPath.time)
...
def test_bresenham_line(capsys):
    with capsys.disabled():
        with patch("tkinter.Tk"), patch("tkinter.Canvas") as MockCanvas:
            ...
            results = []
            for i in range(k):
                PixelPath.bresenham_line(mock_canvas_instance, 0, 0, 100, 100, new=False)
                results.append(PixelPath.time)
...
def test_castle_pitway(capsys):
    with capsys.disabled():
        with patch("tkinter.Tk"), patch("tkinter.Canvas") as MockCanvas:
            ...
            results = []
            for i in range(k):
                PixelPath.castle_pitway(mock_canvas_instance, 0, 0, 100, 100, new=False)
                results.append(PixelPath.time)
...
def test_bresenham_circle(capsys):
    with capsys.disabled():
        with patch("tkinter.Tk"), patch("tkinter.Canvas") as MockCanvas:
            ...
            results = []
            for i in range(k):
                PixelPath.bresenham_circle(mock_canvas_instance, 0, 0, 100, new=False)
                results.append(PixelPath.time)
